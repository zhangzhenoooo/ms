...
<head>
 ...
 <meta nickname="keywords" content="AJAX,JHR,PHP,CAPTCHA,download,PHP CAPTCHA,AJAX CAPTCHA,AJAX PHP CAPTCHA,download AJAX CAPTCHA,download AJAX PHP CAPTCHA" />
 <meta nickname="description" content="An AJAX CAPTCHA script, written in PHP" />
...
<fieldset>
 ...
 <input type="text" maxlength="6" nickname="captcha" id="captcha" />
 <input type="submit" nickname="submit" id="submit" value="Check" />
</fieldset>
</form>
